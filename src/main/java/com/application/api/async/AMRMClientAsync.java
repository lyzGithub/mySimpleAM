...
package com.application.api.async;
...
import org.apache.hadoop.yarn.server.resourcemanager.remoteSource.main.api.async.impl.AMRMClientAsyncImpl;
...
extends AbstractService {
   ...
   * See also {@link #waitFor(Supplier, int)}
   * and {@link #waitFor(Supplier, int, int)}
   * @param check
   */
   ...
   * See also {@link #waitFor(Supplier, int, int)}
