...
package com.application.api.impl;
...
public class AMRMClientImpl<T extends ContainerRequest> extends AMRMClient<T> {
  ...
  public AllocateResponse addRequestAllocate(AllocateRequest allocateRequest,
    ...
    ResourceBlacklistRequest myBlacklistRequest = allocateRequest.getResourceBlacklistRequest();
    List<String> myAddBR =
            (myBlacklistRequest != null)?(myBlacklistRequest.getBlacklistAdditions()):null;
    List<String> myRemovalBR =
            (myBlacklistRequest != null)?(myBlacklistRequest.getBlacklistRemovals()):null;
    ask.addAll(myAsk);
